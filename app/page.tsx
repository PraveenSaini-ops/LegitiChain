  ...
  return (
    <div className="flex flex-col w-full gap-8">
      ...
      <div className="flex justify-between items-end mb-2">
        <div>
          <h1 className="text-3xl font-bold text-[#2D2926] tracking-tight mb-2">Operations Dashboard</h1>
          <p className="text-[#414942] flex items-center gap-2 text-sm">
            <span className="w-2.5 h-2.5 rounded-full bg-[#9fd2ae] inline-block animate-pulse"></span>
        ...
        <div className="flex gap-4">
          <Link
            href="/verify"
            className="px-5 py-2.5 border border-[#E5E0D5] rounded-lg text-xs font-semibold uppercase tracking-widest text-[#2D2926] hover:bg-[#efe7de] transition-colors flex items-center gap-2"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-[#ffffff] border border-[#E5E0D5] rounded-xl p-6 shadow-sm hover:-translate-y-0.5 transition-transform">
          ...
          <div className="text-3xl font-bold text-[#2D2926] mb-1">12,840</div>
        ...
        <div className="bg-[#ffffff] border border-[#E5E0D5] rounded-xl p-6 shadow-sm hover:-translate-y-0.5 transition-transform">
          ...
          <div className="text-3xl font-bold text-[#2D2926] mb-1">156</div>
        ...
        <div className="bg-[#ffffff] border border-[#E5E0D5] rounded-xl p-6 shadow-sm hover:-translate-y-0.5 transition-transform">
          ...
          <div className="text-3xl font-bold text-[#2D2926] mb-1">45,212</div>
          <div className="text-[11px] font-semibold text-[#414942] uppercase tracking-widest">Custody Events</div>
        </div>

        <div className="bg-[#ffdad6]/20 border border-[#C34A36]/30 rounded-xl p-6 shadow-sm hover:-translate-y-0.5 transition-transform">
          <div className="flex justify-between items-start mb-4">
          ...
          <div className="text-3xl font-bold text-[#ba1a1a] mb-1">3</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          ...
          <div className="bg-[#ffffff] border border-[#E5E0D5] rounded-xl shadow-sm overflow-hidden">
            <div className="bg-[#FFEADB] px-6 py-4 border-b border-[#E5E0D5] flex justify-between items-center">
              <h2 className="font-semibold text-lg text-[#370c14]">Recent Chain Activity</h2>
            ...
            <div className="p-6">
              <div className="relative before:absolute before:inset-y-0 before:left-[19px] before:w-[2px] before:bg-[#E5E0D5] flex flex-col gap-6">
                ...
                <div className="relative pl-12">
                  <div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-[#9fd2ae] flex items-center justify-center border-4 border-white z-10 text-[#063b21]">
                    <span className="material-symbols-outlined text-[20px]">upload_file</span>
                  </div>
                  <div className="bg-[#fff8f2] border border-[#E5E0D5] rounded-lg p-4">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="text-xs font-mono text-[#717972]">10:42 AM</span>
                    </div>
                    <div className="bg-[#f4ede4] p-3 rounded border border-[#E5E0D5] flex items-center justify-between mt-3">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded bg-white border border-[#E5E0D5] flex items-center justify-center text-[#717972]">
                      ...
                      <span className="font-mono text-[11px] text-[#414942] bg-white px-2 py-1 border border-[#E5E0D5] rounded">
                ...
                <div className="relative pl-12">
                  ...
                  <div className="bg-[#fff8f2] border border-[#E5E0D5] rounded-lg p-4">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="text-xs font-mono text-[#717972]">09:15 AM</span>
                    </div>
                    <div className="flex gap-4 mt-3">
                      <div className="w-28 border border-[#E5E0D5] rounded p-3 flex flex-col items-center justify-center bg-white">
                      ...
                      <div className="flex-1 bg-[#faf2e9] border border-[#E5E0D5] rounded p-3 text-xs">
                        <p className="font-mono text-[#2D2926] mb-1">Target: Device_Image_MacBookPro_04.dmg</p>
          ...
          {/* Action Alert Banner */}
          <div className="bg-[#3a0e16] border border-[#54232a] rounded-xl shadow-lg p-6 text-white relative overflow-hidden">
            <div className="flex items-center justify-between relative z-10">
              <div>
                <h3 className="text-lg font-bold text-[#ffd9dc] mb-1">Authorization Required</h3>
              ...
              <Link
                href="/custody"
                className="px-5 py-2.5 bg-white text-[#3a0e16] rounded-lg text-xs font-semibold uppercase tracking-widest hover:bg-[#ffd9dc] transition-colors shadow-sm flex items-center gap-2"
              >
                Review Ledger
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          ...
          <div className="bg-[#ffffff] border border-[#E5E0D5] rounded-xl p-6 shadow-sm">
